        ...
        <div className='mx-12'>
            ...
            <div class="hero min-h-screen bg-base-200">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    <img src={emonBg} class="max-w-sm rounded-lg shadow-2xl" />
                    <div>
                        <h1 class="text-5xl font-bold">Abdul Awal Emon</h1>
                        <p class="py-6">Hey, It's Emon. I am a Software Engineering graduate from Yangzhou University, China. I am a junior Web Developer committed to build the most beautiful, functional, and user-friendly websites and web applications. Love to think in React and currently, working and growing on MERN stack..</p>
                        ...
                        <button onClick={handleBtn} class="btn btn-primary mt-5">Connect Now</button>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div class="card card-compact w-96 bg-base-100 shadow-xl">
                        ...
                        <div class="card-body">
                            <h2 class="card-title">Denta Care</h2>
                            <p>An Independent Service Provider Website</p>
                            <div class="card-actions justify-end">
                                <button onClick={handleDentaCare} class="btn btn-primary">Visit Now</button>
                            </div>
                        </div>
                    </div>
                    <div class="card card-compact w-96 bg-base-300 shadow-xl">
                        ...
                        <div class="card-body">
                            <h2 class="card-title">Global Emporium</h2>
                            <p>A Car inventory management website</p>
                            <div class="card-actions justify-end">
                                <button onClick={handleGlobal} class="btn btn-primary">Visit Now</button>
                            </div>
                        </div>
                    </div>
                    <div class="card card-compact w-96 bg-base-100 shadow-xl">
                        ...
                        <div class="card-body">
                            <h2 class="card-title">Instrument Mart</h2>
                            <p>A product analysis website</p>
                            <div class="card-actions justify-end">
                                <button onClick={handleIntrumentMart} class="btn btn-primary">Visit Now</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="card my-10 lg:card-side bg-base-300 shadow-xl">
